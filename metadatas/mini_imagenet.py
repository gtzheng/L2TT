...
from config import _MINI_IMAGENET_DATASET_DIR
...
class MiniImageNet(ProtoData):
    img_size = (84, 84)
    def __init__(self, phase='train', augment='null', mean=[x/255.0 for x in [120.39586422,  115.59361427, 104.54012653]], std=[x/255.0 for x in [70.68188272,  68.27635443,  72.54505529]]):
        ...
        if self.phase=='train':
            ...
            data = load_data(file_train_categories_val_phase)
        elif self.phase=='val':
        ...
        elif self.augment == 'auto_augment' or self.augment == 'auto_augment_cutmix':
