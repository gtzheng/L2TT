...
class MiniImageNet(data.Dataset):
    def __init__(self, phase='train', mean_pix = [x/255.0 for x in [120.39586422,  115.59361427, 104.54012653]],std_pix = [x/255.0 for x in [70.68188272,  68.27635443,  72.54505529]], do_not_use_random_transf=False, aug_num=1, aug_method='normal'):
